...
<div id="app" class="page-container">
    <div class="text-l">
        <input type="text" v-model="search.name" placeholder="银行名称" style="width:250px" class="input-text">
            ...
            <div class="modal-body">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-5">
                        <input type="text" class="input-text" placeholder="请输入银行名称" v-model="entity.name" datatype="*1-100" nullmsg="请输入名称！">
                    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-5">
                        <input type="text" class="input-text" placeholder="请输入负责人姓名" v-model="entity.persion" datatype="*1-10" nullmsg="负责人不能为空">
                    </div>
                    <div class="col-xs-5"></div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-5">
                        <input type="test" class="input-text" placeholder="请输入手机号"  v-model="entity.phone" datatype="m" nullmsg="请输入手机号" >
                    </div>
                    <div class="col-xs-5"> </div>
                </div>
            </div>
    ...
    new Vue({
                ...
                methods: {
                    getData: function (curr) { //获取数据
                        var self = this;
                        $.getJSON("${ctxyy}/bank/list", this.search, function (res) {
                            self.list = res.extra;
                        });
                    },
                    ...
                    deleteData: function (index) {//删除元素
                        ...
                        $.post('${ctxyy}/bank/delete', {id: id}, function (res) {
                            if (res.code == '200') {
                                //更新列表
                                self.getData(1)
                            }else{
