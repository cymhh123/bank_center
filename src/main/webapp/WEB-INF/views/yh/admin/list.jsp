...
<div id="app" class="page-container">
    <div class="text-l">
        <input type="text" v-model="search.account" placeholder="管理员账号" style="width:250px" class="input-text">
        ...
        <form action="" class="form form-horizontal responsive" id="dataform">
            <div class="modal-body">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-5">
                        <input type="text" class="input-text" placeholder="请输入手机号码" v-model="entity.phone" datatype="m" nullmsg="请输入手机号码">
                    </div>
                    <div class="col-xs-5"></div>
                </div>
            </div>
    ...
    new Vue({
        ...
        methods: {
            getData: function (curr) { //获取数据
                var self = this;
                $.getJSON("${ctxyh}/admin/list", this.search, function (res) {
                    self.list = res.extra;
                });
            },
            ...
            deleteData: function (index) {//删除元素
                ...
                $.post('${ctxyh}/admin/delete', {id: id}, function (res) {
                    if (res.code == '200') {
                        //更新列表
                        self.getData(1)
                    }else{
